...
constexpr auto pixelFormats = BidirectionalMap<>::Create(
    ...
    PIXELFORMAT_R8_INT,           DkImageFormat_R8_Sint,
    PIXELFORMAT_R8_UINT,          DkImageFormat_R8_Uint,
    PIXELFORMAT_R16_UNORM,        DkImageFormat_R16_Unorm,
    PIXELFORMAT_R16_FLOAT,        DkImageFormat_R16_Float,
    PIXELFORMAT_R16_INT,          DkImageFormat_R16_Sint,
    PIXELFORMAT_R16_UINT,         DkImageFormat_R16_Uint,
    PIXELFORMAT_R32_FLOAT,        DkImageFormat_R32_Float,
    PIXELFORMAT_R32_INT,          DkImageFormat_R32_Sint,
    PIXELFORMAT_R32_UINT,         DkImageFormat_R32_Uint,
    PIXELFORMAT_RG8_UNORM,        DkImageFormat_RG8_Unorm,
    PIXELFORMAT_RG8_INT,          DkImageFormat_RG8_Sint,
    PIXELFORMAT_RG8_UINT,         DkImageFormat_RG8_Uint,
    ...
    PIXELFORMAT_BC4_SNORM,        DkImageFormat_R_BC4_Snorm,
    PIXELFORMAT_BC5_UNORM,        DkImageFormat_RG_BC5_Unorm,
    PIXELFORMAT_BC5_SNORM,        DkImageFormat_RG_BC5_Snorm,
    PIXELFORMAT_BC6H_UFLOAT,      DkImageFormat_RGBA_BC6H_UF16_Float,
    PIXELFORMAT_BC6H_SFLOAT,      DkImageFormat_RGBA_BC6H_SF16_Float,
