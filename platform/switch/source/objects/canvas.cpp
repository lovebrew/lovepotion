    ...
    descriptor {}
{
    ...
    this->colorMemory = ::deko3d::Instance().AllocatePool(
        deko3d::MEMPOOL_IMAGES, layoutColorBuffer.getSize(), layoutColorBuffer.getAlignment());
    ...
    this->handle = ::deko3d::Instance().RegisterDescriptor(this->descriptor);
