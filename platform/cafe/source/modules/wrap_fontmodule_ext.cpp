...
using Rasterizer = love::Rasterizer<love::Console::CAFE>;
...
int Wrap_FontModule::NewTrueTypeRasterizer(lua_State* L)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                const auto systemFonts = FontModule<Console::CAFE>::systemFonts;
...
{
    ::Rasterizer* self = nullptr;
    const auto type    = (OSSharedDataType)systemFont;
