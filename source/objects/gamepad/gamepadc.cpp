...
StringMap<Gamepad::GamepadAxis, Gamepad::GAMEPAD_AXIS_MAX_ENUM> Gamepad::axes(
    Gamepad::axisEntries, sizeof(Gamepad::axisEntries));

StringMap<Gamepad::GamepadButton, Gamepad::GAMEPAD_BUTTON_MAX_ENUM>::Entry
...
StringMap<Gamepad::GamepadButton, Gamepad::GAMEPAD_BUTTON_MAX_ENUM> Gamepad::buttons(
...
StringMap<Gamepad::InputType, Gamepad::INPUT_TYPE_MAX_ENUM> Gamepad::inputTypes(
    Gamepad::inputTypeEntries, sizeof(Gamepad::inputTypeEntries));
