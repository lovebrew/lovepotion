...
// clang-format off
constexpr static StringMap<PixelFormat, PIXELFORMAT_MAX_ENUM>::Entry formatEntries[] =
{
...
constinit const StringMap<PixelFormat, PIXELFORMAT_MAX_ENUM> ImageModule::pixelFormats(formatEntries);
// clang-format on
