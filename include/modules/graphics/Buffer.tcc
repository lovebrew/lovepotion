...
namespace love
{
     ...
     **/
    class BufferBase : public love::Object, public Resource
    {
      public:
        ...
        struct Settings
        {
            ...
            Settings(uint32_t usageflags, BufferDataUsage dataUsage) :
        ...
        BufferBase(GraphicsBase* gfx, const Settings& settings, const std::vector<DataDeclaration>& format,
        ...
        {
            return dataMembers[index];
        }
        size_t getMemberOffset(int index) const
        {
            return dataMembers[index].offset;
        }
        ...
        {
          public:
            Mapper(BufferBase& buffer, MapType maptype = MAP_WRITE_INVALIDATE) : buffer(buffer)
            {
