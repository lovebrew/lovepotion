...
namespace Wrap_Mesh
{
    ...
    int setVertexAttribute(lua_State* L);

    int getVertexAttribute(lua_State* L);

    int getVertexCount(lua_State* L);

    int getVertexFormat(lua_State* L);

    int setAttributeEnabled(lua_State* L);

    int isAttributeEnabled(lua_State* L);

    int attachAttribute(lua_State* L);

    int detachAttribute(lua_State* L);

    int getAttachedAttributes(lua_State* L);
