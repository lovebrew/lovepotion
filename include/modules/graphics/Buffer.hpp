    ...
    namespace graphics
    {
        ...
        class Buffer : public love::Object, public Resource
        {
          public:
            ...
            Buffer(Graphics* gfx, const Settings& settings, const std::vector<DataDeclaration>& format,
            ...
            {
              public:
                Mapper(Buffer& buffer, MapType maptype = MAP_WRITE_INVALIDATE) : buffer(buffer)
                {
