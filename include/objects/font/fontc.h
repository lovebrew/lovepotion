...
namespace love::common
{
    class Font : public love::Object
    {
        public:
            ...
            virtual void Printf(Graphics * gfx, const std::vector<ColoredString> & text, float wrap, AlignMode align,
                                const Matrix4 & localTransform, const Colorf & color) = 0;
            ...
            static Font * GetSystemFontByType(int size, SystemFontType type, const Texture::Filter & filter = Texture::defaultFilter);
